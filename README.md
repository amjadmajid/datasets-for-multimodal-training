...
| <a href="https://github.com/M2RL/m2rl-dataset"> M2RL </a>   | 2024 | Multi‑interface robot learning from human demonstrations    | \~360 trajectories (\~1 M image frames) over 8 manipulation tasks; data include RGB+D from three views, operator’s ego view & gaze, plus robot proprioception | Not specified    |
